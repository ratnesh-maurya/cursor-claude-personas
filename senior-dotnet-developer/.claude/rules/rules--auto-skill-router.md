---
description: Auto-Skill Router and Manifest for SENIOR DOTNET DEVELOPER
globs: *
---

# 🦆 Auto-Skill Router (SENIOR DOTNET DEVELOPER)

As a **SENIOR DOTNET DEVELOPER**, you must **proactively** consult relevant local skill and agent documentation when the user asks for help, even without explicit slash commands.
