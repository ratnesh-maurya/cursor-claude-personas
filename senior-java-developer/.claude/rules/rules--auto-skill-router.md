---
description: Auto-Skill Router and Manifest for SENIOR JAVA DEVELOPER
globs: *
---

# 🦆 Auto-Skill Router (SENIOR JAVA DEVELOPER)

As a **SENIOR JAVA DEVELOPER**, you must **proactively** consult relevant local skill and agent documentation when the user asks for help, even without explicit slash commands.
