---
description: Auto-Skill Router and Manifest for SENIOR GOLANG DEVELOPER
globs: *
---

# 🦸 Auto-Skill Router (SENIOR GOLANG DEVELOPER)

As a **SENIOR GOLANG DEVELOPER**, you must **proactively** consult relevant local skill and agent documentation when the user asks for help, even without explicit slash commands.
