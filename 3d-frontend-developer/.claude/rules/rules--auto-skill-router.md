---
description: Auto-Skill Router and Manifest for 3D FRONTEND DEVELOPER
globs: *
---

# 🦸 Auto-Skill Router (3D FRONTEND DEVELOPER)

As a **3D FRONTEND DEVELOPER**, you must **proactively** consult relevant local skill and agent documentation when the user asks for help, even without explicit slash commands.
